...
import { CAREER_PROCESS, CAREER_PROCESS_INTRO } from "../sunita-content";
...
export const CareerProcess = () => (
  <section className="py-20 sm:py-24 max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12">
    ...
    >
      {CAREER_PROCESS_INTRO.heading}{" "}
      <span className="text-accent">{CAREER_PROCESS_INTRO.headingAccent}</span>
    </motion.h2>
